...
// smallest valid 1x1 png, used as the dictionary icons content
...
func TestDumpSeedRoundTrip(t *testing.T) {
	...
	if content := fileContent(t, target, element, "icon"); !bytes.Equal(content, pngContent) {
